...
| **OCR** | 40–80ms **ที่ region ขนาด subtitle** | 30ms บน region (S1) · **99ms @1920×1080** (S1, n=92) · **~305ms @3440×1440** (วัดจริงตอนรัน) |
| translate (cache miss) | ~300-500ms | **485ms p50 / 1108ms p95** ⚠️ เกิน — และ ~408ms ในนั้นเป็นเวลาที่ Google ใช้คิด (transport floor แค่ 77ms) เราคุมไม่ได้ |
| render | ~16ms | ยังไม่ได้วัดแยก |

**ตัวเลข OCR ไม่มีความหมายถ้าไม่บอกขนาด region** — เวลาแปรตามพื้นที่ตรงๆ 40–80ms เป็นเลขของ region ขนาด subtitle ไม่ใช่ของเต็มจอ การเทียบข้ามขนาดเคยทำให้สรุปผิดมาแล้ว (#49)
